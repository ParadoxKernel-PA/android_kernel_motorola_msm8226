...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMARTASSFALCON)
extern struct cpufreq_governor cpufreq_gov_smartass_falcon;
#define CPUFREQ_DEFAULT_GOVERNOR        (&cpufreq_gov_smartass_falcon)
#endif
